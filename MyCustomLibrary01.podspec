...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/your_name/MyCustomLibrary01'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'your_name' => 'your_email' }
  s.source           = { :git => 'https://github.com/your_name/MyCustomLibrary01.git', :tag => s.version.to_s }
  # s.social_media_url = 'https://twitter.com/<TWITTER_USERNAME>'

  s.ios.deployment_target = '8.0'

  s.source_files = 'MyCustomLibrary01/Classes/**/*'
